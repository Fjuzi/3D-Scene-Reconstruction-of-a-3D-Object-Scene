...
%
% Input: 
%   - R(3,3) rotation matrix between the two cameras
%   - T(3) translation vector the two cameras
%   - K(3,3,2) intrinsic parameter matrices of both cameras
%   - q(3,npoints,2) hom. coordinates of the projected points in both cameras
%
% Output: 
%   - Q(4,npoints) euclidean homogeneus coordinates of the obtained 3D points
