function v= homography_solve_vmmc(pin, pout)
...
% Based on an implementation by David Young, University of Sussex, February 2008
...
% Define the homogeneous system of equations to be solved 
